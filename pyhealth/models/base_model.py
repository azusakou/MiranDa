...
class BaseModel(ABC, nn.Module):
    ...
    def get_hembedding_layers(
        ...
        for key, tokenizer in feature_tokenizers.items():
            ...
            embedding_layers[key] = PoincareEmbedding(
                tokenizer.get_vocabulary_size(),
                embedding_dim,
                ball,
                padding_idx=tokenizer.get_padding_index(),
...
class PoincareEmbedding(nn.Module):
    ...
    def __init__(self, num_embeddings, embedding_dim, ball=None, padding_idx=None,
                 max_norm=None, norm_type=2., scale_grad_by_freq=False,
                 sparse=False, _weight=None, init_std=1e-2):
        ...
        if _weight is None:
            ...
            # self.weight =  ManifoldParameter(_weight, manifold=ball)
    ...
    def forward(self, input):
        # return self.ball.expmap0(F.embedding(
        return (F.embedding(
