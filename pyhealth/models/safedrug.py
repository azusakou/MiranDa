...
class SafeDrugLayer(nn.Module):
    ...
    def calculate_loss(
        ...
        #import dill
        #with open('/home/user/Documents/CODE/MIMIC/PyHealth/pyhealth/metrics/ddi_eicu.pkl', 'wb') as f:
        #    dill.dump(self.ddi_adj, f)
...
class SafeDrug(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #hball = geoopt.Scaled(geoopt.ProductManifold((geoopt.Euclidean(), 96), (geoopt.PoincareBall(), 32)))
        #self.hembeddings = self.get_hembedding_layers(self.feat_tokenizers, embedding_dim, hball)
        self.embeddings = self.get_embedding_layers(self.feat_tokenizers, embedding_dim)
        ...
        '''
        self.cond_rnn = hyperDense(embedding_dim,hidden_dim)
        '''
    ...
    def forward(
        ...
        # conditions = self.embeddingscon(conditions)
