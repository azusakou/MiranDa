    ...
    def search_drug(self,
        ...
        if len(vectors) >= 3:
            ...
            if top_similarities[1]<0.35:
                ...
                match_embedding1 = torch.mean(torch.tensor(self.feature_extract(vectors_info[top_indices[0]])[0]), dim=0)
                match_embedding2 = torch.mean(torch.tensor(self.feature_extract(vectors_info[top_indices[1]])[0]), dim=0)
