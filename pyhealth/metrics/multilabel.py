...
def multilabel_metrics_fn(
    ...
    for metric in metrics:
        if metric == "roc_auc_micro":
        ...
        elif metric == "ddi_rate":
            from .drug_recommendation import ddi_rate_score_w
            if dataset_name == 'mimic3':
                ddi_path = "/home/user/Documents/CODE/MIMIC/PyHealth/pyhealth/metrics/ddi_mimic3.pkl"
            elif dataset_name == 'mimic4':
                ddi_path = "/home/user/Documents/CODE/MIMIC/PyHealth/pyhealth/metrics/ddi_mimic4.pkl"
            elif dataset_name == 'eicu':
                ddi_path = "/home/user/Documents/CODE/MIMIC/PyHealth/pyhealth/metrics/ddi_eicu.pkl"
            ...
            ddi_rate = ddi_rate_score_w([y_pred], ddi_path)
            output["ddi_rate"] = ddi_rate
        else:
